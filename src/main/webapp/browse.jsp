...
<body style="font-family: Arial; font-size: 20px;">
	...
	<div
		...
		<b> 
			<a href="<%=request.getContextPath()%>/bookmark?Locale=de_DE"
			style="font-size: 16px; color: white; margin-left: 10px; text-decoration: none;">German (DE)</a>
			<a href="<%=request.getContextPath()%>/bookmark?Locale=es_ES"
			style="font-size: 16px; color: white; margin-left: 10px; text-decoration: none;">Spanish (ES)</a>
			<a href="<%=request.getContextPath()%>/bookmark?Locale=hi_IN"
			style="font-size: 16px; color: white; margin-left: 10px; text-decoration: none;">Hindi (IN)</a>
			<a href="<%=request.getContextPath()%>/bookmark"
			style="font-size: 16px; color: white; margin-left: 10px; text-decoration: none;">English (US)</a>
	...
	<hr>
	<p style="font-size: 15px">Selected locale : ${Locale}<br>
	Page request language : <%= request.getLocale() %></p>
</body>
</html>